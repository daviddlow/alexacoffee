...
describe("Testing AMAZON.HelpIntent", function() {
  ...
  "version": "1.0"
	...
	describe("The response is structurally correct for Alexa Speech Services", function() {
		...
		it("should have a closing message from the getDialogue function Help > Generic array", function() {
			expect(speechResponse.response.outputSpeech.ssml).to.equal(dialogue.ssmlIfy(dialogue.pickPhrase(dialogue.phrases.help.generic)));
		})
